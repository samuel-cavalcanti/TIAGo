...
struct ModeState_
{
  ...
  _mode_type mode;
    ...
    enum { BEGIN = -1 };
     enum { MODE_POSITION = 0 };
     enum { MODE_VELOCITY = 1 };
     enum { MODE_EFFORT = 2 };
     enum { NOMODE = 3 };
     enum { EMERGENCY_STOP = 4 };
     enum { SWITCHING = 5 };
     enum { ERROR = 6 };
...
// {'mode_state_controller': ['/home/samuel/tiago_public_ws/src/ros_controllers/mode_state_controller/msg'], 'std_msgs': ['/opt/ros/indigo/share/std_msgs/cmake/../msg']}
