...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'run_motion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/samuel/tiago_public_ws/src/tiago_tutorials/run_motion/${idir}'.  Ask the maintainer 'Jordi Pages <jordi.pages@pal-robotics.com>, Sammy Pfeiffer <sam.pfeiffer@pal-robotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/samuel/tiago_public_ws/devel/.private/run_motion/lib;/home/samuel/tiago_public_ws/devel/lib;/opt/ros/indigo/lib)
