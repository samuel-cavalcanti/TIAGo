...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pal_gripper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/samuel/tiago_public_ws/install/${idir}'.  Ask the maintainer 'TIAGo support team <tiago-support@pal-robotics.com>' to fix it.")
    endif()
